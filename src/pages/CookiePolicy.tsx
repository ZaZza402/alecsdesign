...
const CookiePolicy = () => {
  ...
  return (
    <div className="legal-page">
      <SEO
        title={`${t("legal.cookies.title")} | AlecsDesign`}
        description={t("legal.cookies.what.text").substring(0, 160)}
        keywords="cookie policy, cookies usage, tracking policy, alecsdesign cookies"
      />
