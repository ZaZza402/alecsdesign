...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="legal-page">
      <SEO
        title={`${t("legal.privacy.title")} | AlecsDesign`}
        description={t("legal.privacy.intro.text").substring(0, 160)}
        keywords="privacy policy, data protection, gdpr, alecsdesign privacy"
      />
